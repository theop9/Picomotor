# -*- coding: utf-8 -*-
"""
Created on Thu Jun 12 09:46:35 2025
...
try:
    while running:
        ...
        text_print.tprint(screen, f"            : {'x' if indexVitesse != [1,0] else 'X'} -> : {vitesse[1,0]},    {'y' if indexVitesse != [1,1] else 'Y'} v : {vitesse[1,1]},    {'z' if indexVitesse != [1,2] else 'Z'} v : {vitesse[1,2]} ")
        text_print.tprint(screen, '')
        ...
        text_print.tprint(screen, f"            : {'x' if indexVitesse != [3,0] else 'X'} <- : {vitesse[3,0]},    {'y' if indexVitesse != [3,1] else 'Y'} v : {vitesse[3,1]},    {'z' if indexVitesse != [3,2] else 'Z'} v : {vitesse[3,2]} ")
        ...
        # print(f"toggleChangingVitesse : {toggleChangingVitesse}")
        # print(f"indexVitesse : {indexVitesse}")
        # print(vitesse)
